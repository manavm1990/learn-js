...
If you're on **Windows**, you might be used to **PowerShell** or `cmd.exe`. You _can_ use PowerShell if you really want to—most of the commands we teach (`pwd`, `ls`, `cd`) will still work because PowerShell provides them as aliases. Just know that dome details and options may look a little different than what you see in the lesson.
