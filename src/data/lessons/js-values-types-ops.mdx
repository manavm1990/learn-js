...
Your first steps with JavaScript: **variables,** `console.log`, and **running files with Bun**.

## Introduction

### Welcome to JavaScript!

You're about to write your first JavaScript code! JavaScript is the programming language of the web - it runs in every browser and powers interactive websites. But it's also much more: with Bun (and other runtimes), JavaScript runs on servers, mobile apps, and even desktop applications.
...
- Runs in web browsers and on servers or just your local computer outside of a browser via Bun (or Node.js, Deno, etc.)
...
- Ensures consistency across different environments (browsers, Bun, Node.js, Deno)
...
- **Runtime**: The platform that executes JavaScript code (Bun, Node.js, Deno)
- **Engine**: The core component that interprets and runs JavaScript (JavaScriptCore, V8, SpiderMonkey)

Summarily, each browser has its own JavaScript engine (e.g., Chrome uses V8, Firefox uses SpiderMonkey). Bun uses JavaScriptCore (from Safari) to run JavaScript on servers and local machines with exceptional speed. Node.js uses V8 (from Chrome).
