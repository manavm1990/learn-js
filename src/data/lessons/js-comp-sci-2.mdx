...
JavaScript evaluates non-boolean values as either **truthy** or **falsy** in boolean contexts. This is type coercion at work — the same concept you saw in [Program Structure](/program-structure).
